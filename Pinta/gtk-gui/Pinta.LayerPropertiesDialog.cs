...
namespace Pinta
{
	public partial class LayerPropertiesDialog
	{
		...
		protected virtual void Build ()
		{
			...
			this.checkbutton1.Label = global::Mono.Unix.Catalog.GetString ("Visible");
			this.checkbutton1.DrawIndicator = true;
			this.checkbutton1.UseUnderline = true;
			this.vbox2.Add (this.checkbutton1);
			global::Gtk.Box.BoxChild w5 = ((global::Gtk.Box.BoxChild)(this.vbox2[this.checkbutton1]));
			w5.Position = 1;
			w5.Expand = false;
			w5.Fill = false;
			// Container child vbox2.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w9 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.hscale1]));
			w9.Position = 2;
